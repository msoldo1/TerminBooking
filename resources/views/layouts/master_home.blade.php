...
<!-- Colors CSS -->
<link rel="stylesheet" href="{{ asset('fontend/css/colors.css') }}">
<!-- ALL VERSION CSS -->
<link rel="stylesheet" href="{{ asset('fontend/css/versions.css') }}">
<!-- Responsive CSS -->
...
<!-- end font family -->
<link rel="stylesheet" href="{{ asset('fontend/css/3dslider.css') }}" />
<script src="http://code.jquery.com/jquery-1.11.1.min.js"></script>
<link href="http://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
<script src="{{ asset('fontend/js/3dslider.js') }}"></script>
</head>
<body class="game_info" data-spy="scroll" data-target=".header">
<!-- LOADER -->
<div id="preloader">
    <img class="preloader" src="{{ asset('fontend/') }}images/loading-img.gif" alt="">
</div>
<!-- END LOADER -->
<section id="top">
    <header>
            ...
            <div class="header-top">
                <div class="row">
                    <div class="col-md-6">
                        <div class="full">
                            <div class="logo">
                                <h1 class="color-yellow">Booking Termin</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <ul class="login">
                                @auth
                                    <li class="login-modal">
                                        <a href="{{ route('user.logout') }}" class="login"><i class="fa fa-user"></i>Logout</a>
                                    </li>
                                @else
                                <li>
                ...
                <div class="item skyblue" data-ride="carousel" data-interval="5000">
                    <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div class="slider-contant" data-animation="animated fadeInRight">
                                <h3>If you Don’t Practice<br>You <span class="color-yellow">Don’t Derserve</span><br>to win!</h3>
                                <button class="btn btn-primary btn-lg">Rezerviraj termin</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="full">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="#"><img src="{{ asset('fontend/images/footer-logo.png') }}" alt="#" /></a>
                        </div>
...
<script src="{{ asset('fontend/js/all.js') }}"></script>
<!-- ALL PLUGINS -->
