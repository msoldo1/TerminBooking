                ...
                <div class="matchs-vs">
                    <div class="vs-team">
                        <div class="team-btw-match">
                            <ul>
                                <li>
                                    <img src="{{ asset('fontend/images/img-03.png')}}" alt="">
                                    <span>Footbal Team</span>
                                </li>

                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src=" {{ asset('fontend/images/img-04.png') }}" alt="">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12">
                <aside id="sidebar" class="left-bar">
                    <div class="banner-sidebar">
                        <img class="img-responsive" src="{{ asset('fontend/images/img-05.jpg') }}" alt="#" />
                ...
                <aside id="sidebar" class="left-bar">
                    <div class="feature-matchs">
                        <div class="team-btw-match">
                            <ul>
                                <li>
                                    <img src="{{ asset('fontend/images/img-01_002.png') }}" alt="">
                                    <span>Portugal</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src="{{ asset('fontend/images/img-02.png') }}" alt="">
                                    <span>Germany</span>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <img src="{{ asset('fontend/images/img-03_002.png') }}" alt="">
                                    <span>Portugal</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src="{{ asset('fontend/images/img-04_003.png') }}" alt="">
                                    <span>Germany</span>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <img src="{{ asset('fontend/images/img-05_002.png') }}" alt="">
                                    <span>Portugal</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src="{{ asset('fontend/images/img-06.png') }}" alt="">
                                    <span>Germany</span>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <img src="{{ asset('fontend/images/img-07_002.png') }}" alt="">
                                    <span>Portugal</span>
                                </li>
                                <li class="vs"><span>vs</span></li>
                                <li>
                                    <img src="{{ asset('fontend/images/img-08.png') }}" alt="">
                                    <span>Germany</span>
                                </li>
                            </ul>
                            <ul>
                ...
                <aside id="sidebar" class="left-bar">
                    <div class="feature-matchs">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>1</td>
                                <td><img src="{{ asset('fontend/images/img-01_004.png') }}" alt="">Liverpool</td>
                                <td>10</td>
                                <td>12</td>
                                <td>20</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><img src="{{ asset('fontend/images/img-02_002.png') }}" alt="">Chelsea</td>
                                <td>10</td>
                                <td>12</td>
                                <td>20</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td><img src="{{ asset('fontend/images/img-03_003.png') }}" alt="">Norwich City</td>
                                <td>20</td>
                                <td>15</td>
                                <td>20</td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td><img src="{{ asset('fontend/images/img-04_002.png') }}" alt="">West Brom</td>
                                <td>60</td>
                                <td>10</td>
                                <td>60</td>
                            </tr>
                            <tr>
                                <td>5</td>
                                <td><img src="{{ asset('fontend/images/img-05.png') }}" alt="">sunderland</td>
                                <td>30</td>
                                <td>06</td>
                                <td>30</td>
                            </tr>
            ...
            <div class="col-lg-8 col-sm-8 col-xs-12">
                <div class="news-post-holder">
                    <div class="news-post-widget">
                        <img class="img-responsive" src="{{ asset('fontend/images/img-01_002.jpg') }}" alt="">
                    ...
                    <div class="news-post-widget">
                        <img class="img-responsive" src="{{ asset('fontend/images/img-02_003.jpg') }}" alt="">
                        <div class="news-post-detail">
                            <span class="date">20 march 2016</span>
                            <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                            <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                ...
                <div class="news-post-holder">
                    <div class="news-post-widget">
                        <img class="img-responsive" src="{{ asset('fontend/images/img-03_003.jpg') }}" alt="">
                        <div class="news-post-detail">
                            <span class="date">20 march 2016</span>
                            <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                            <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
            ...
            <div class="col-md-12">
                <div class="full">
                    <div class="match_vedio">
                        <img class="img-responsive" src="{{ asset('fontend/images/img-07.jpg') }}" alt="#" />
                    </div>
                </div>
            </div>
        </div>
